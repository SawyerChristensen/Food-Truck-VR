	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float3 WorldPosition2_g1029 = ase_worldPos;
				float temp_output_7_0_g1032 = AHF_FogDistanceStart;
				float temp_output_155_0_g1029 = saturate( ( ( distance( WorldPosition2_g1029 , _WorldSpaceCameraPos ) - temp_output_7_0_g1032 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g1032 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch467_g1029 = temp_output_155_0_g1029;
				#else
				float staticSwitch467_g1029 = ( 1.0 - pow( ( 1.0 - abs( temp_output_155_0_g1029 ) ) , AHF_FogDistanceFalloff ) );
				#endif
				half FogDistanceMask12_g1029 = staticSwitch467_g1029;
				float3 lerpResult258_g1029 = lerp( (AHF_FogColorStart).rgb , (AHF_FogColorEnd).rgb , ( ( FogDistanceMask12_g1029 * FogDistanceMask12_g1029 * FogDistanceMask12_g1029 ) * AHF_FogColorDuo ));
				float3 normalizeResult318_g1029 = normalize( ( WorldPosition2_g1029 - _WorldSpaceCameraPos ) );
				float dotResult145_g1029 = dot( normalizeResult318_g1029 , AHF_DirectionalDir );
				half Jitter502_g1029 = 0.0;
				float temp_output_140_0_g1029 = ( saturate( (( dotResult145_g1029 + Jitter502_g1029 )*0.5 + 0.5) ) * AHF_DirectionalIntensity );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch470_g1029 = temp_output_140_0_g1029;
				#else
				float staticSwitch470_g1029 = pow( abs( temp_output_140_0_g1029 ) , AHF_DirectionalFalloff );
				#endif
				float DirectionalMask30_g1029 = staticSwitch470_g1029;
				float3 lerpResult40_g1029 = lerp( lerpResult258_g1029 , (AHF_DirectionalColor).rgb , DirectionalMask30_g1029);
				#ifdef AHF_DISABLE_DIRECTIONAL
				float3 staticSwitch442_g1029 = lerpResult258_g1029;
				#else
				float3 staticSwitch442_g1029 = lerpResult40_g1029;
				#endif
				half3 Input_Color6_g1030 = staticSwitch442_g1029;
				#ifdef UNITY_COLORSPACE_GAMMA
				float3 staticSwitch1_g1030 = Input_Color6_g1030;
				#else
				float3 staticSwitch1_g1030 = ( Input_Color6_g1030 * ( ( Input_Color6_g1030 * ( ( Input_Color6_g1030 * 0.305306 ) + 0.6821711 ) ) + 0.01252288 ) );
				#endif
				half3 Final_Color462_g1029 = staticSwitch1_g1030;
				half3 AHF_FogAxisOption181_g1029 = AHF_FogAxisOption;
				float3 break159_g1029 = ( WorldPosition2_g1029 * AHF_FogAxisOption181_g1029 );
				float temp_output_7_0_g1033 = AHF_FogDistanceEnd;
				float temp_output_643_0_g1029 = saturate( ( ( distance( WorldPosition2_g1029 , _WorldSpaceCameraPos ) - temp_output_7_0_g1033 ) / ( ( AHF_FogDistanceEnd + AHF_FarDistanceOffset ) - temp_output_7_0_g1033 ) ) );
				half FogDistanceMaskFar645_g1029 = ( temp_output_643_0_g1029 * temp_output_643_0_g1029 );
				float lerpResult690_g1029 = lerp( AHF_FogHeightEnd , ( AHF_FogHeightEnd + AHF_FarDistanceHeight ) , FogDistanceMaskFar645_g1029);
				float temp_output_7_0_g1034 = lerpResult690_g1029;
				float temp_output_167_0_g1029 = saturate( ( ( ( break159_g1029.x + break159_g1029.y + break159_g1029.z ) - temp_output_7_0_g1034 ) / ( AHF_FogHeightStart - temp_output_7_0_g1034 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch468_g1029 = temp_output_167_0_g1029;
				#else
				float staticSwitch468_g1029 = pow( abs( temp_output_167_0_g1029 ) , AHF_FogHeightFalloff );
				#endif
				half FogHeightMask16_g1029 = staticSwitch468_g1029;
				float lerpResult328_g1029 = lerp( ( FogDistanceMask12_g1029 * FogHeightMask16_g1029 ) , saturate( ( FogDistanceMask12_g1029 + FogHeightMask16_g1029 ) ) , AHF_FogLayersMode);
				float mulTime204_g1029 = _TimeParameters.x * 2.0;
				float3 temp_output_197_0_g1029 = ( ( WorldPosition2_g1029 * ( 1.0 / AHF_NoiseScale ) ) + ( -AHF_NoiseSpeed * mulTime204_g1029 ) );
				float3 p1_g1038 = temp_output_197_0_g1029;
				float localSimpleNoise3D1_g1038 = SimpleNoise3D( p1_g1038 );
				float temp_output_7_0_g1037 = AHF_NoiseMin;
				float temp_output_7_0_g1036 = AHF_NoiseDistanceEnd;
				half NoiseDistanceMask7_g1029 = saturate( ( ( distance( WorldPosition2_g1029 , _WorldSpaceCameraPos ) - temp_output_7_0_g1036 ) / ( 0.0 - temp_output_7_0_g1036 ) ) );
				float lerpResult198_g1029 = lerp( 1.0 , saturate( ( ( localSimpleNoise3D1_g1038 - temp_output_7_0_g1037 ) / ( AHF_NoiseMax - temp_output_7_0_g1037 ) ) ) , ( NoiseDistanceMask7_g1029 * AHF_NoiseIntensity ));
				half NoiseSimplex3D24_g1029 = lerpResult198_g1029;
				#ifdef AHF_DISABLE_NOISE3D
				float staticSwitch42_g1029 = lerpResult328_g1029;
				#else
				float staticSwitch42_g1029 = ( lerpResult328_g1029 * NoiseSimplex3D24_g1029 );
				#endif
				float temp_output_454_0_g1029 = ( staticSwitch42_g1029 * AHF_FogIntensity );
				half Final_Alpha463_g1029 = temp_output_454_0_g1029;
				float4 appendResult114_g1029 = (float4(Final_Color462_g1029 , Final_Alpha463_g1029));
				float4 appendResult457_g1029 = (float4(WorldPosition2_g1029 , 1.0));
				#ifdef AHF_DEBUG_WORLDPOS
				float4 staticSwitch456_g1029 = appendResult457_g1029;
				#else
				float4 staticSwitch456_g1029 = appendResult114_g1029;
				#endif
				float3 temp_output_96_86_g1028 = (staticSwitch456_g1029).xyz;
				float temp_output_96_87_g1028 = (staticSwitch456_g1029).w;
				float3 lerpResult82_g1028 = lerp( _Color.rgb , temp_output_96_86_g1028 , temp_output_96_87_g1028);
				...
				surfaceDescription.Color = lerpResult82_g1028;
        ...
        Pass
		{
					...
					)
			{
				...
				float3 ase_worldViewDir = ( _WorldSpaceCameraPos.xyz - ase_worldPos );
				ase_worldViewDir = normalize(ase_worldViewDir);
				float fresnelNdotV79 = dot( packedInput.normalWS, ase_worldViewDir );
				float fresnelNode79 = ( 0.0 + 1.0 * pow( 1.0 - fresnelNdotV79, 5.0 ) );
...
/*ASEBEGIN
Version=19108
Node;AmplifyShaderEditor.Vector3Node;30;-512,2048;Half;False;Property;_NoiseSpeed;Noise Speed;45;0;Create;True;0;0;0;False;0;False;0.5,0.5,0;1,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;32;-512,1824;Half;False;Property;_NoiseScale;Noise Scale;44;0;Create;True;0;0;0;False;0;False;6;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;50;0,1728;Inherit;False;Property;_VertexIntensity;Vertex Intensity;46;0;Create;True;0;0;0;False;0;False;0;0.03;0;0.2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;5;768,896;Inherit;False;Property;_Color;Color;43;1;[HDR];Create;True;0;0;0;False;0;False;1,0,0,0;0.6415094,0.006621321,0,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
WireConnection;97;0;106;85
WireConnection;97;2;81;0
WireConnection;97;6;48;0
WireConnection;106;81;5;0
ASEEND*/
//CHKSM=7409B80DA9529B4D67928FF907ADF10D106C0AA4
