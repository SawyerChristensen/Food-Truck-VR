	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				half3 WorldPosFromDepth_SRP567_g963 = ( _WorldSpaceCameraPos - ( eyeDepth218_g963 * ( ( _WorldSpaceCameraPos - ase_worldPos ) / computeScreenPos225_g963.w ) ) );
				float3 objToView587_g963 = TransformWorldToView( TransformObjectToWorld(packedInput.ase_texcoord2.xyz) );
				float clampDepth572_g963 = SampleCameraDepth( ase_screenPosNorm.xy );
				float lerpResult577_g963 = lerp( ( 1.0 - clampDepth572_g963 ) , clampDepth572_g963 , saturate( _ProjectionParams.x ));
				float lerpResult579_g963 = lerp( _ProjectionParams.y , _ProjectionParams.z , lerpResult577_g963);
				float3 appendResult582_g963 = (float3(objToView587_g963.x , objToView587_g963.y , -lerpResult579_g963));
				float3 viewToWorld583_g963 = GetAbsolutePositionWS(mul( UNITY_MATRIX_I_V, float4( appendResult582_g963, 1 ) ).xyz);
				half3 WorldPosFromDepth_SRP_Ortho584_g963 = viewToWorld583_g963;
				float3 lerpResult593_g963 = lerp( WorldPosFromDepth_SRP567_g963 , WorldPosFromDepth_SRP_Ortho584_g963 , ( unity_OrthoParams.w + ( _FogCameraMode * 0.0 ) ));
				#if defined(AHF_CAMERAMODE_PERSPECTIVE)
				float3 staticSwitch589_g963 = WorldPosFromDepth_SRP567_g963;
				#elif defined(AHF_CAMERAMODE_ORTHOGRAPHIC)
				float3 staticSwitch589_g963 = WorldPosFromDepth_SRP_Ortho584_g963;
				#elif defined(AHF_CAMERAMODE_BOTH)
				float3 staticSwitch589_g963 = lerpResult593_g963;
				#else
				float3 staticSwitch589_g963 = WorldPosFromDepth_SRP567_g963;
				#endif
				half3 WorldPosFromDepth253_g963 = staticSwitch589_g963;
				float3 WorldPosition2_g963 = WorldPosFromDepth253_g963;
				float temp_output_7_0_g1022 = AHF_FogDistanceStart;
				float temp_output_155_0_g963 = saturate( ( ( distance( WorldPosition2_g963 , _WorldSpaceCameraPos ) - temp_output_7_0_g1022 ) / ( AHF_FogDistanceEnd - temp_output_7_0_g1022 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				float staticSwitch467_g963 = temp_output_155_0_g963;
				#else
				float staticSwitch467_g963 = ( 1.0 - pow( ( 1.0 - abs( temp_output_155_0_g963 ) ) , AHF_FogDistanceFalloff ) );
				#endif
				half FogDistanceMask12_g963 = staticSwitch467_g963;
				float3 lerpResult258_g963 = lerp( (AHF_FogColorStart).rgb , (AHF_FogColorEnd).rgb , ( ( FogDistanceMask12_g963 * FogDistanceMask12_g963 * FogDistanceMask12_g963 ) * AHF_FogColorDuo ));
				...
				float lerpResult494_g963 = lerp( 0.0 , frac( ( frac( dotResult16_g1020 ) * (Magic14_g1020).z ) ) , ( AHF_JitterIntensity * 0.1 ));
				half Jitter502_g963 = lerpResult494_g963;
				float temp_output_140_0_g963 = ( saturate( (( dotResult145_g963 + Jitter502_g963 )*0.5 + 0.5) ) * AHF_DirectionalIntensity );
				#ifdef AHF_DISABLE_FALLOFF
				...
				#endif
				half3 Input_Color6_g1012 = staticSwitch442_g963;
				...
				#endif
				half3 Final_Color462_g963 = staticSwitch1_g1012;
				...
				float temp_output_643_0_g963 = saturate( ( ( distance( WorldPosition2_g963 , _WorldSpaceCameraPos ) - temp_output_7_0_g1024 ) / ( ( AHF_FogDistanceEnd + AHF_FarDistanceOffset ) - temp_output_7_0_g1024 ) ) );
				half FogDistanceMaskFar645_g963 = ( temp_output_643_0_g963 * temp_output_643_0_g963 );
				float lerpResult690_g963 = lerp( AHF_FogHeightEnd , ( AHF_FogHeightEnd + AHF_FarDistanceHeight ) , FogDistanceMaskFar645_g963);
				float temp_output_7_0_g1025 = lerpResult690_g963;
				float temp_output_167_0_g963 = saturate( ( ( ( break159_g963.x + break159_g963.y + break159_g963.z ) - temp_output_7_0_g1025 ) / ( AHF_FogHeightStart - temp_output_7_0_g1025 ) ) );
				#ifdef AHF_DISABLE_FALLOFF
				...
				float3 p1_g1029 = temp_output_197_0_g963;
				...
				half NoiseDistanceMask7_g963 = saturate( ( ( distance( WorldPosition2_g963 , _WorldSpaceCameraPos ) - temp_output_7_0_g1027 ) / ( 0.0 - temp_output_7_0_g1027 ) ) );
				float lerpResult198_g963 = lerp( 1.0 , saturate( ( ( localSimpleNoise3D1_g1029 - temp_output_7_0_g1028 ) / ( AHF_NoiseMax - temp_output_7_0_g1028 ) ) ) , ( NoiseDistanceMask7_g963 * AHF_NoiseIntensity ));
				...
				float temp_output_176_0_g963 = saturate( ( ( abs( temp_output_449_0_g963 ) - temp_output_7_0_g1026 ) / ( 0.0 - temp_output_7_0_g1026 ) ) );
